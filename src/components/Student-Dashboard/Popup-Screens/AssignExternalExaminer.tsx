...
function AssignExternalExaminer({
  onClose,
  selectedStudent,
  getData,
  label,
  ...
  const handleSubmit = () => {
    ...
    if(minor){
      ...
      .post(BaseUrl + "user/session", {
        ...
        "external_defense.date": String(minor),
        external_defense:{
          date:String(minor)
        }
      ...
      <div className="font-pop  flex flex-row lg:overflow-hidden bg-gray-100">
        <div className="w-full text-black">
          ...
          <div className="mx-10">
            ...
            <div className="w-full ">
              <div>Set / Change for External Examiner</div>
              <input
...
export default AssignExternalExaminer;
