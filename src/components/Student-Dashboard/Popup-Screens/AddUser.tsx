...
function AddUSer({ onClose, getData }: UploadPopUpProps) {
  ...
  const handleInputChange = (name: string, value: string) => {
    if(name=="is_student"){
      setUserData((prevData) => ({ ...prevData, [name]: value==="Student"?true:false }));
    }else{
          ...
          <div className="xs:text-[1rem] md:text-[1.2rem] gap-y-2 lg:flex lg:flex-col lg:items-center w-full">
            ...
            <DropDown
             ...
             <DropDown
                ...
                data={userData.is_student?["MSC","PGD"]:["HOD","Dean","Dean PG","Departmental PG Coordinator","Faculty PG Coordinator"]}
                className="borderBlack border-2 xs:w-[100%] lg:w-[17rem] mb-1 h-[2.5rem] px-2 rounded-[0.7rem]
              outline-none  focus:border-[#a1812e]"
              />
            </div>
            ...
            {
              userData.is_student &&<div className="flex xs:flex-col xs:items-center xs:justify-center lg:flex-row lg:gap-48">
              <DropDown
                  divClassName="flex flex-col xs:w-[80%]"
                  labelText="Section:"
                  id="dropDown"
            ...
            <div className="my-1 xs:mx-5">
              ...
              <div className="mt-3 flex justify-center">
                ...
                >
                  <span className="text-base text-white">Add {userData.is_student?"Student":"Lecturer"}</span>
