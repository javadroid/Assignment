...
const SignUp: React.FC = () => {
  ...
  return (
    <div className='font-pop xs:overflow-auto xs:m-auto lg:h-screen lg:overflow-auto 2xl:overflow-hidden lg:px-28 text-gray-500'>
      {/* Sign up header */}
      ...
      <div className='xs:mx-[1.5rem] lg:mx-[3rem] my-4'>
        ...
        <form className=''>
          <div className='xs:text-[1rem] md:text-[1.2rem] gap-y-2 lg:flex lg:flex-col lg:items-center w-full'>
            ...
            <div className='flex w-full xs:flex-col xs:items-center xs:justify-center lg:ml-[5rem] 1xl:ml-[13rem] 2xl:ml-[29rem] lg:flex-row lg:gap-48'>
              <InputField
                labelText='Matric No:'
                id='userID'
                type='text'
